...
/// <code>ChatUI</code> is the access point for the UI of the Chat SDK. It is the ChatEngine.
SWIFT_CLASS_NAMED("ChatUI")
@interface ZDKChatUI : NSObject
/// Product Identifier
@property (nonatomic, readonly, copy) NSString * _Nonnull id;
/// Returns TRUE if SDK is enabled.
@property (nonatomic, readonly) BOOL isEnabled;
/// The type of Engine <code>.deflection</code>/<code>.resolution</code>
@property (nonatomic, readonly) enum EngineType type;
/// State can be inactive, active, stopped
@property (nonatomic, readonly) enum ZDKEngineState state;
...
/// Initialize the ChatUI with configs
/// \param configs configs
///
///
/// throws:
/// <code>ChatError.chatIsNotInitialized</code> error, if Chat was not previously initialized
- (nullable instancetype)initWith:(NSArray<id <ZDKConfiguration>> * _Nonnull)configs error:(NSError * _Nullable * _Nullable)error OBJC_DESIGNATED_INITIALIZER;
...
- (void)start;
/// Conversation SDK decided to end the current session.
- (void)end;
